...
const { emailVerificationCode,verifyRecoverCode,resetPasswordParent } = require("../../../Controllers/Auth")
...
router.post("/resetPassword",resetPasswordValidator, resetPasswordParent);
